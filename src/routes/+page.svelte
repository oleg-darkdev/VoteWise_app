...
{#if startQuiz}
<section
	class="mx-auto flex h-screen w-full max-w-7xl items-center justify-center px-4 py-12 sm:px-6 md:px-12 lg:px-24 lg:py-24"
>
	<div class="mb-12 flex w-full flex-col text-center">
		...
		<div class="mx-auto mt-6 flex w-full max-w-4xl justify-center gap-2">
			<div class="mt-3 rounded-lg sm:mt-0">
				<button on:click={()=> startQuiz = !startQuiz}
